...
function Header() {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <Link to={'/cart'} className="inline-flex items-center text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none
     hover:bg-indigo-700 rounded text-base mt-4 md:mt-0">Go To Cart
