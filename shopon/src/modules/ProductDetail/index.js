            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex">
                    <button
                      className="flex ml-auto mr-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded"
                      onClick={() => handleAddCart(productDetail, true)}
                    >
                      Buy it now
                    </button>
                    <button
