...
import deleteicon from "../../assests/red-delete-10437.png";
...
function Cart() {
  ...
  const handleCheckout = () => {
    localStorage.clear();
    enqueueSnackbar("Items checked out successfully, Thank You", {
      variant: "success",
    });
    navigate("/");
  };
  ...
  return (
    <div className="container mx-auto mt-10">
      <div className="flex shadow-md my-10 flex-wrap flex-col lg:flex-row">
            ...
            return (
              <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                ...
                <div className="flex justify-center w-1/5">
                  <div
                    className="fill-current flex items-center justify-center w-3 cursor-pointer"
                    onClick={() => handleDec(cart?.id, cart?.quantity)}
                  >
                    {cart.quantity === 1 ? (
                      <img className="h-4" src={deleteicon} />
                    ) : (
                      <svg
